...
from helpers.randaugment import RandAugment

COCO_FEATURES = torch.load('helpers/coco_features.pt')['features']
ADE_FEATURES = torch.load('helpers/ade_features.pt')['features']
DETECTION_FEATURES = torch.load('helpers/detection_features.pt')['features']
BACKGROUND_FEATURES = torch.load('helpers/background_features.pt')
