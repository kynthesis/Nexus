...
from archs.nexus_caption import NexusCaption
from helpers import create_dataset, create_loader
from utils import *
...
parser.add_argument('--config', default='configs/pretrain-zero.yaml')
...
if args.shard_grad_op:  # Model Sharding: ZeRO 2
    ...
    from archs.modules.vit import ResidualAttentionBlock
    from archs.modules.resampler import PerceiverAttentionBlock
    from archs.modules.roberta import RobertaLayer
